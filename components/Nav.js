...
const Nav = ({ aboutRef, projectRef, experienceRef, homeRef }) => {
	...
	return (
		<div className="w-full justify-center flex z-20">
			<nav
				className="w-full fixed top-0 left-0 text-2xl grid grid-rows-1 grid-cols-3 p-4 place-content-center"
			>
				<div className="col-start-3 flex md:flex-row flex-col justify-end items-end md:py-4 md:gap-x-4 gap-y-4 ">
					<MovingShadow>
				...
				<div className="col-start-2 row-start-1 w-full flex justify-between gap-x-4 md:items-center text-sm font-bold w-full">
					<div className="grow" />
